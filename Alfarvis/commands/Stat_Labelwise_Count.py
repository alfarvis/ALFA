...
class Stat_Labelwise_Count(AbstractCommand):
    ...
    def commandTags(self):
        ...
        """
        return ["labelwise count", "labelwise","groupwise count", "groupwise", "count"]
    ...
    def evaluate(self, array_datas):
        ...
        if uniqVals is not None:
            df_new = df.groupby('ground_truth').count()
            ...
            for col in df_new.columns:
                ...
                result_object.createName(kName, command_name='labelwise count',
