...
class Cluster_spectral(Cluster_kmeans):
    def __init__(self):
        super(Cluster_spectral, self).__init__(["spectral clustering", "cluster", "spectral"])
...
class Cluster_hierarchical(Cluster_kmeans):
    def __init__(self):
        super(Cluster_hierarchical, self).__init__(["hierarchical clustering", "cluster", "hierarchical"])
