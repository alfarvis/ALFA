...
class Stat_Labelwise_Mean(AbstractCommand):
    """
    ...
    def commandTags(self):
        ...
        """
        return ["labelwise mean", "labelwise average","labelwise","groupwise mean", "groupwise average","groupwise",  "mean","average"]
    ...
    def evaluate(self, array_datas):
        ...
        if uniqVals is not None:
            df_new = df.groupby('ground_truth').mean()
            ...
            for col in df_new.columns:
                ...
                result_object.createName(kName, command_name='labelwise mean',
